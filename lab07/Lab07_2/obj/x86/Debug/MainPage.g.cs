#pragma checksum "C:\Users\LEGION\source\repos\App2\Lab07_2\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "0E4BF9346F78E7CF3D68146195F4ABC0"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lab07_2
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj4_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::Lab07_2.Models.Contact dataRoot;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::Lab07_2.Models.Contact) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::Lab07_2.Models.Contact)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::Lab07_2.Models.Contact obj, int phase)
            {
                if (obj != null)
                {
        ...
        private class MainPage_obj13_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::Lab07_2.Models.Icon dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            private bool removedDataContextHandler = false;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::Lab07_2.Models.Icon) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::Lab07_2.Models.Icon)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::Lab07_2.Models.Icon obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::Lab07_2.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::Lab07_2.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::Lab07_2.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Contacts(global::System.Collections.ObjectModel.ObservableCollection<global::Lab07_2.Models.Contact> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_Icons(global::System.Collections.Generic.List<global::Lab07_2.Models.Icon> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
